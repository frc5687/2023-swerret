...
// import org.frc5687.swerret.commands.Auto.HoverToPose;
// import org.frc5687.swerret.commands.CubeShooter.AutoIntake;
// import org.frc5687.swerret.commands.CubeShooter.AutoShoot;
// import org.frc5687.swerret.commands.EndEffector.EjectStow;
// import org.frc5687.swerret.commands.SemiAuto.*;
import org.frc5687.swerret.subsystems.*;
// import org.frc5687.swerret.util.CustomController;
// import org.frc5687.swerret.util.Nodes;
...
public class OI extends OutliersProxy {
    ...
    public void initializeButtons(
        ...
        // _operatorJoystick.button(8).or(_operatorJoystick.button(9))
        //         .onTrue(new ZeroSuperStructure(elevator, arm, endEffector));
        ...
        // _driverGamepad.getYButton().onTrue(new SnapTo(drivetrain, new
        // Rotation2d(Units.degreesToRadians(0))));
        // _driverGamepad.getAButton().onTrue(new SnapTo(drivetrain, new
        // Rotation2d(Units.degreesToRadians(180))));
        // _driverGamepad.getBButton().whileTrue(new HoverToPose(drivetrain,
        // cubeShooter, lights));
    ...
    public double getArmY() {
        // double speed = -getSpeedFromAxis(_driverGamepad,
        // Gamepad.Axes.RIGHT_Y.getNumber());
        // speed = applyDeadband(speed, Constants.DriveTrain.ROTATION_DEADBAND);
    ...
    public double getExtArmY() {
        // double speed = -getSpeedFromAxis(_operatorGamepad,
        // Gamepad.Axes.RIGHT_Y.getNumber());
        // speed = applyDeadband(speed, Constants.DriveTrain.ROTATION_DEADBAND);
        // return speed;
        return 0;
